...
const AdminAnalytics = () => {
 ...
 <span className="text-sm font-bold text-neutral-content uppercase tracking-widest">Total Revenue</span>
 </div>
 ...
 <span className="text-sm font-bold text-neutral-content uppercase tracking-widest">Active Users</span>
 </div>
 <h2 className="text-3xl font-black text-base-content">{dashboardStats?.activeUsers || 0}</h2>
 </div>
 </div>
