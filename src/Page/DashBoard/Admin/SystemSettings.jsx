    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-gray-800 flex items-center gap-3">
          <FaCogs className="text-[#1A3626]" /> System Settings
        </h1>
        <p className="text-gray-500 mt-1">Configure global application behavior and security protocols.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-2">Maintenance Mode</h3>
          ...
          <div className="mt-auto w-full">
            <div className={`mb-6 flex items-center justify-center gap-2 font-bold uppercase tracking-widest text-xs ${
              ...
              <div className={`w-2 h-2 rounded-full animate-pulse ${config?.maintenanceMode ? 'bg-red-500' : 'bg-green-500'}`}></div>
        ...
        <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 flex flex-col items-center text-center opacity-70 cursor-not-allowed">
          <div className="w-16 h-16 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mb-6">
            <FaShieldAlt className="text-2xl" />
          </div>
          <h3 className="text-xl font-bold text-gray-800 mb-2">Security Hardening</h3>
          <p className="text-gray-500 text-sm mb-8">
            Advanced DDoS protection and IP whitelisting for administrative access.
          </p>
          <div className="mt-auto w-full py-4 rounded-2xl bg-gray-100 text-gray-400 font-bold uppercase tracking-widest text-xs">
            Coming Soon
          </div>
        </div>
        ...
        <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 flex flex-col items-center text-center opacity-70 cursor-not-allowed">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-2">Debug Console</h3>
          <p className="text-gray-500 text-sm mb-8">
